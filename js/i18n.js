...
(function () {
  ...
  var T = {
    en: {
      ...
      /* plans */
      'plans.title':   'Get your eSIM data plan now and travel smarter!',
      'plans.sub':     'Choose the plan that fits your trip',
      'plans.tab.city':  'City Traveler',
      'plans.tab.multi': 'Multi-country',
      'plan.city.bestfor1': 'Best For: Short Trips',
      'plan.city.bestfor2': 'Best For: Mid Length Trips',
      'plan.city.bestfor3': 'Best For: Long Stays',
      'plan.city.title3':   'Unlimited for 30 days',
      'plan.multi.bestfor1': 'Best For: Quick Multi-Country Trips',
      'plan.multi.bestfor2': 'Best For: Multi-Country Travel',
      'plan.multi.bestfor3': 'Best For: Extended Multi-Country Stays',
      'plan.multi.title3':   'Unlimited for 30 days',
      'plan.feat.speed':   'Speed',
      'plan.feat.hotspot': 'Hotspot',
      'plan.feat.days':    'Days Valid',
      'plan.feat.yes':     'Yes',
      'plan.buy':      'Get Your eSIM Instantly',
    ...
    de: {
      ...
      /* plans */
      'plans.title':   'Holen Sie sich jetzt Ihren eSIM-Datentarif und reisen Sie smarter!',
      'plans.sub':     'Wählen Sie den passenden Tarif für Ihre Reise',
      'plans.tab.city':  'Stadtreisende',
      'plans.tab.multi': 'Mehrere Länder',
      'plan.city.bestfor1': 'Ideal für: Kurztrips',
      'plan.city.bestfor2': 'Ideal für: Mittelange Reisen',
      'plan.city.bestfor3': 'Ideal für: Längere Aufenthalte',
      'plan.city.title3':   'Unbegrenzt für 30 Tage',
      'plan.multi.bestfor1': 'Ideal für: Schnelle Multi-Länder-Trips',
      'plan.multi.bestfor2': 'Ideal für: Multi-Länder-Reisen',
      'plan.multi.bestfor3': 'Ideal für: Längere Multi-Länder-Aufenthalte',
      'plan.multi.title3':   'Unbegrenzt für 30 Tage',
      'plan.feat.speed':   'Geschwindigkeit',
      'plan.feat.hotspot': 'Hotspot',
      'plan.feat.days':    'Gültig (Tage)',
      'plan.feat.yes':     'Ja',
      'plan.buy':      'eSIM sofort holen',
    ...
    zh: {
      ...
      /* plans */
      'plans.title':   '立即获取您的eSIM流量套餐，畅游日本！',
      'plans.sub':     '选择最适合您旅行的套餐',
      'plans.tab.city':  '城市旅行者',
      'plans.tab.multi': '多国旅行',
      'plan.city.bestfor1': '最适合：短途旅行',
      'plan.city.bestfor2': '最适合：中等长度旅行',
      'plan.city.bestfor3': '最适合：长期旅居',
      'plan.city.title3':   '无限流量 30天',
      'plan.multi.bestfor1': '最适合：快速多国行',
      'plan.multi.bestfor2': '最适合：多国旅行',
      'plan.multi.bestfor3': '最适合：长期多国旅居',
      'plan.multi.title3':   '无限流量 30天',
      'plan.feat.speed':   '网速',
      'plan.feat.hotspot': '热点共享',
      'plan.feat.days':    '有效天数',
      'plan.feat.yes':     '是',
      'plan.buy':      '立即获取eSIM',
      'plan.popular':  '★ 最受欢迎 ★',
  ...
  function applyCurrency(currency) {
    ...
    /* plan-price-main: new structure with .plan-price-amount and .plan-price-usd */
    document.querySelectorAll('.plan-price-main[data-jpy]').forEach(function (el) {
      var jpy = parseInt(el.getAttribute('data-jpy'), 10);
      var amountEl = el.querySelector('.plan-price-amount');
      var usdEl    = el.querySelector('.plan-price-usd');
      if (amountEl) amountEl.textContent = formatPrice(jpy, currency);
      if (usdEl)    usdEl.textContent    = '/' + currency;
    });
