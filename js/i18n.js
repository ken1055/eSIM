...
(function () {
  ...
  var T = {
    en: {
      ...
      /* hero */
      'hero.title':    'Skip SIM Cards.<br>Get Online in Japan<br>in Seconds.',
      ...
      /* why */
      'why.title': 'Why ESIMJAPAN.com is Best for Japan eSIM',
      /* support */
      ...
      'how.sub':   'Get eSIM at your fingertips, Get ready for your Japan trip!',
      'how.s1':    'Pick a plan',
      'how.s1p':   'Choose the plan that suits your travel needs and place an order.',
      'how.s2':    'Scan the QR code',
      'how.s2p':   'Receive the QR code via email and scan it for instant activation.',
      'how.s3':    'Ready to go!',
      'how.s3p':   'Now that your data concerns are taken care of, you can have an enjoyable trip.',
      /* first time */
    ...
    de: {
      ...
      /* hero */
      'hero.title':    'Keine SIM-Karte nötig.<br>In Sekunden online in Japan.',
      ...
      /* why */
      'why.title': 'Warum ESIMJAPAN.com die beste Wahl für Japan eSIM ist',
      /* support */
      ...
      'how.sub':   'Einfach, schnell und reisebereit!',
      'how.s1':    'Tarif wählen',
      'how.s1p':   'Wählen Sie den passenden Tarif und bestellen Sie.',
      'how.s2':    'QR-Code scannen',
      'how.s2p':   'Erhalten Sie den QR-Code per E-Mail und scannen Sie ihn zur Aktivierung.',
      'how.s3':    'Fertig!',
      'how.s3p':   'Jetzt können Sie Ihre Japan-Reise ohne Datenprobleme genießen.',
      /* first time */
    ...
    zh: {
      ...
      /* why */
      'why.title': '为什么ESIMJAPAN.com是日本eSIM的最佳选择',
      /* support */
      ...
      'how.sub':   '简单三步，轻松畅游日本！',
      'how.s1':    '选择套餐',
      'how.s1p':   '根据您的旅行需求选择套餐并下单。',
      'how.s2':    '扫描二维码',
      'how.s2p':   '通过邮件接收二维码，扫描即可立即激活。',
      'how.s3':    '出发！',
      'how.s3p':   '流量问题已解决，尽情享受您的日本之旅吧。',
      /* first time */
